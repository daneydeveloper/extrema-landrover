    ...
    //***************************
      ...
      jQuery('.automobile-images-thumb').slick({
          ...
          jQuery('.automobile-images-list').slick({
            ...
            dots: false,
            vertical: false,
            prevArrow: "<span class='slick-arrow-left invisivel'><i class='icon-arrows23'></i>Previous Vehicle</span>",
            nextArrow: "<span class='slick-arrow-right invisivel'>Next Vehicle<i class='icon-right-arrow'></i></span>",
            centerMode: false,
            focusOnSelect: true,
            responsive: [
                  {
